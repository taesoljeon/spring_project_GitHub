...
<div class="row container-fluid login" >
	...
	<form action="${pageContext.request.contextPath}/product/product_update.product" method="post" id="registrationform">
		<fieldset>
			<legend>상품정보</legend>
			...
			<div class="form-group text-right">
				<div>
					...
					<input type="submit" value="수정하기" class="btn btn-default" style="background-color: black; color: white;"> 
