		...
		<div class="col">
			...
			<div class="col-sm-3">
				<c:choose>
					...
					<strong style="float:right;">입찰가 : <fmt:formatNumber value="${bid.bid_price}" pattern="#,###,###,###" /> 원</strong>
					<c:if test="${bid.bid_condition_code == 1}">
						<br><span class="text-right" style="float:right; font-size:12px; color:gray;" id="bidcancle"><a href="${pageContext.request.contextPath}/bid/bid_cancle.bid?bid_code=${bid.bid_code}" style="color:gray;">입찰취소</a></span>
					</c:if>
				<br>
			</div>
		</div>
